...
test-5a-big-integer-arithmetic: node.o stack.o operand.o arithmetic-expression.o big-integer-arithmetic.o test/test-5a-big-integer-arithmetic.cpp
test-5b-big-integer-arithmetic: node.o stack.o operand.o arithmetic-expression.o big-integer-arithmetic.o test/test-5b-big-integer-arithmetic.cpp
